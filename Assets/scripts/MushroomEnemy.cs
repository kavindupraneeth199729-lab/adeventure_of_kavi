...
public class MushroomEnemy : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (animator != null) animator.enabled = true; // Ensure enabled
        ...
        if (enemyHealth != null)
        {
            ...
            enemyHealth.enemyName = "Mushroom";
        }
        ...
        if (player != null)
        {
            ...
            Debug.Log($"MushroomEnemy: Snapped to Player Depth: {targetZ}");
        }
        ...
        Debug.Log($"MushroomEnemy STARTED: Pos={transform.position} | Order={sr.sortingOrder}");
